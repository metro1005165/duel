...
public class FragmentDuelTop extends Fragment {
	...
	public static FragmentDuelTop newInstance() {

		FragmentDuelTop duelTop = new FragmentDuelTop();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.fragment_duel_top, container, false);
		...
		public void onClick(View v) {
			...
			for (int i = 0; i < 4; i++) {
				...
				if (cbAttack.isChecked()) {
					result.put("attack_type", i);
				}
				
				if (cbBlock.isChecked()) {
					if (blockType == 1) {
						result.put("block_type_" + blockType, i);
						blockType++;
					}
